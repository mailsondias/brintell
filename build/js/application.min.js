...
$(function(){
	...
	$formContato.on('submit',function(e) {
		...
		var	nome       = $formContato.children(".field-nome").val(),
			nome_      = nome.trim(),
			nome__     = nome.split(' '),
			name       = nome__[0],
			email      = $formContato.children(".field-email").val(),
			email_     = email.trim(),
			telefone   = $formContato.children(".field-telefone").val(),
			mensagem   = $formContato.children(".field-mensagem").val(),
			dataString = 'nome='+ nome_ + '&email=' + email_ + '&telefone=' + telefone + '&mensagem=' + mensagem
        ...
        // if((nome != "") && (email != "") && (telefone != "") && (mensagem != "")) {
	        ...
	        //     url: "http://antoniomonteiro-phd.com.br/inc/sendmail.php",
	        //     data: dataString,
	        //     success: function(){
        	// 		return response('success', name, this)
	        //     },
	        //     error: function(){
	...
	$formInscricao.on('submit',function(e) {
		...
		var	nome       = $formInscricao.children(".field-nome").val(),
			nome_      = nome.trim(),
			nome__     = nome.split(' '),
			name       = nome__[0],
			email      = $formInscricao.children(".field-email").val(),
			email_     = email.trim(),
			telefone   = $formInscricao.children(".field-telefone").val(),
			mensagem   = $formInscricao.children(".field-mensagem").val(),
			dataString = 'nome='+ nome_ + '&email=' + email_ + '&telefone=' + telefone + '&mensagem=' + mensagem
	...
	function carousel()
	{
		$('.mindset .carousel').slick({
			...
			// fade: true,
			// cssEase: 'linear',
			prevArrow: $('.mindset .carousel .btn-prev'),
			nextArrow: $('.mindset .carousel .btn-next'),
			responsive: [
			{
				breakpoint: 992,
				settings: {
